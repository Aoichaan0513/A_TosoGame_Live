...
public class Scoreboard {
    ...
    private static HashMap<UUID, org.bukkit.scoreboard.Scoreboard> hashMap = new HashMap<>();

    public static org.bukkit.scoreboard.Scoreboard setBoard(Player p) {
        org.bukkit.scoreboard.Scoreboard scoreboard = hashMap.containsKey(p.getUniqueId()) ? hashMap.get(p.getUniqueId()) : Teams.setScoreboard(Bukkit.getScoreboardManager().getNewScoreboard());
    ...
    private static void setTeams(Player p, org.bukkit.scoreboard.Scoreboard scoreboard) {
        ...
        switch (GameManager.getGameState()) {
            case READY:
                ...
                status.setSuffix("" + ChatColor.GOLD + ChatColor.BOLD + ChatColor.UNDERLINE + TimeFormat.formatJapan(GameRunnable.getCountDown()));
                break;
            case GAME:
                status.setPrefix(ChatColor.RED + "残り" + ChatColor.RESET + ChatColor.GRAY + ": ");
                status.setSuffix("" + ChatColor.DARK_RED + ChatColor.BOLD + ChatColor.UNDERLINE + TimeFormat.formatJapan(GameRunnable.getGameTime()));
                break;
            case END:
                status.setPrefix("");
                status.setSuffix("" + ChatColor.GRAY + ChatColor.BOLD + "   ゲーム終了" + ChatColor.RESET);
                break;
            default:
                status.setPrefix("");
                status.setSuffix("" + ChatColor.GREEN + ChatColor.BOLD + "  ゲーム準備中…" + ChatColor.RESET);
                break;
        }
        ...
        rate.setSuffix(ChatColor.GRAY + "  (" + MoneyManager.getRate(p) + "円/秒)");
        ...
        teamPlayer.setSuffix(ChatColor.WHITE + String.valueOf(Teams.getOnlineCount(Teams.OnlineTeam.TOSO_PLAYER)) + ChatColor.GRAY + "人");
        ...
        teamHunter.setSuffix(ChatColor.RED + String.valueOf(Teams.getOnlineCount(Teams.OnlineTeam.TOSO_HUNTER)) + ChatColor.GRAY + "人");
        ...
        teamJail.setSuffix(ChatColor.BLACK + String.valueOf(Teams.getOnlineCount(Teams.OnlineTeam.TOSO_JAIL)) + ChatColor.GRAY + "人");
        ...
        teamSuccess.setSuffix(ChatColor.BLUE + String.valueOf(Teams.getOnlineCount(Teams.OnlineTeam.TOSO_SUCCESS)) + ChatColor.GRAY + "人");
        ...
        teamTuho.setSuffix(ChatColor.GREEN + String.valueOf(Teams.getOnlineCount(Teams.OnlineTeam.TOSO_TUHO)) + ChatColor.GRAY + "人");
    }

    public static org.bukkit.scoreboard.Scoreboard getBoard(Player p) {
        return hashMap.containsKey(p.getUniqueId()) ? hashMap.get(p.getUniqueId()) : setBoard(p);
    }

    public static HashMap<UUID, org.bukkit.scoreboard.Scoreboard> getBoardMap() {
        return hashMap;
    }
    ...
    public static void updateScoreboard() {
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            org.bukkit.scoreboard.Scoreboard scoreboard = hashMap.get(player.getUniqueId());

            Team status = scoreboard.getTeam(TosoGameAPI.Objective.SIDEBAR_STATUS.getName());
            switch (GameManager.getGameState()) {
                case READY:
                    status.setPrefix(ChatColor.YELLOW + "残り" + ChatColor.RESET + ChatColor.GRAY + ": ");
                    status.setSuffix("" + ChatColor.GOLD + ChatColor.BOLD + ChatColor.UNDERLINE + TimeFormat.formatJapan(GameRunnable.getCountDown()));
            ...
            scoreboard.getTeam(TosoGameAPI.Objective.SIDEBAR_REWARD.getName()).setSuffix(getReward(player));
            scoreboard.getTeam(TosoGameAPI.Objective.SIDEBAR_RATE.getName()).setSuffix(ChatColor.GRAY + "  (" + MoneyManager.getRate(player) + "円/秒)");

            scoreboard.getTeam(TosoGameAPI.Objective.SIDEBAR_TEAM_PLAYER.getName()).setSuffix(ChatColor.WHITE + String.valueOf(Teams.getOnlineCount(Teams.OnlineTeam.TOSO_PLAYER)) + ChatColor.GRAY + "人");
            scoreboard.getTeam(TosoGameAPI.Objective.SIDEBAR_TEAM_HUNTER.getName()).setSuffix(ChatColor.RED + String.valueOf(Teams.getOnlineCount(Teams.OnlineTeam.TOSO_HUNTER)) + ChatColor.GRAY + "人");
            scoreboard.getTeam(TosoGameAPI.Objective.SIDEBAR_TEAM_JAIL.getName()).setSuffix(ChatColor.BLACK + String.valueOf(Teams.getOnlineCount(Teams.OnlineTeam.TOSO_JAIL)) + ChatColor.GRAY + "人");
            scoreboard.getTeam(TosoGameAPI.Objective.SIDEBAR_TEAM_SUCCESS.getName()).setSuffix(ChatColor.BLUE + String.valueOf(Teams.getOnlineCount(Teams.OnlineTeam.TOSO_SUCCESS)) + ChatColor.GRAY + "人");
            scoreboard.getTeam(TosoGameAPI.Objective.SIDEBAR_TEAM_TUHO.getName()).setSuffix(ChatColor.GREEN + String.valueOf(Teams.getOnlineCount(Teams.OnlineTeam.TOSO_TUHO)) + ChatColor.GRAY + "人");
        }
    }

    private static String getReward(Player p) {
        return Teams.hasJoinedTeam(Teams.OnlineTeam.TOSO_ADMIN, p) || Teams.hasJoinedTeam(Teams.OnlineTeam.TOSO_JAIL, p) ? "" + ChatColor.GRAY + ChatColor.STRIKETHROUGH + MoneyManager.formatMoney(MoneyManager.getReward(p)) + "円" : ChatColor.GOLD + MoneyManager.formatMoney(MoneyManager.getReward(p)) + ChatColor.GRAY + "円";
    }
